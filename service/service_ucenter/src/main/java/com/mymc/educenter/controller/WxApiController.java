package com.mymc.educenter.controller;
...
import com.mymc.educenter.utils.ConstantPropertiesUtil;
import com.mymc.educenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String callback(String code,String state) {
        try {
            ...
            throw new XueException(20001,"微信扫码登陆失败");
        }
